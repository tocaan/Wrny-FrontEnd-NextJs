                        ...
                        <div className="col-sm-5 col-md-6 col-lg-3">
                            <ul className="list-inline mb-0 mt-0">
                                <li className="list-inline-item">
                                    <Link className="btn btn-sm px-2 bg-facebook mb-0" href="#"><i className="fab fa-fw fa-facebook-f"></i></Link>
                                </li>
                                <li className="list-inline-item">
                                    <Link className="btn btn-sm shadow px-2 bg-instagram mb-0" href="#"><i className="fab fa-fw fa-instagram"></i></Link>
                                </li>
                                <li className="list-inline-item">
                                    <Link className="btn btn-sm shadow px-2 bg-twitter mb-0" href="#"><i className="fab fa-fw fa-twitter"></i></Link>
                                </li>
                                <li className="list-inline-item">
                                    <Link className="btn btn-sm shadow px-2 bg-linkedin mb-0" href="#"><i className="fab fa-fw fa-linkedin-in"></i></Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link className="nav-link active" href="/">
                            ...
                            <span className="mb-0 nav-text">الرئيسية</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" href="/account-profile">
                            ...
                            <span className="mb-0 nav-text">الملف الشخصي</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" href="/events">
                            ...
                            <span className="mb-0 nav-text">الفعاليات</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" href="/login">
                            ...
                            <span className="mb-0 nav-text">تسجيل الدخول</span>
                        </Link>
                    </li>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" href="#">
                            ...
                            <span className="mb-0 nav-text">English</span>
                        </Link>
                    </li>
                </ul>
            </nav>
